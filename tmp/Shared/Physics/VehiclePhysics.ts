...
export class VehiclePhysics extends Serializable
{
  ...
  {
    this.getPhysicsBody().applyForce(new Vector(force));
  }
  /// TEST:
  public getForce()
  {
    return this.getPhysicsBody().getForce();
  }
...
// }
  ...
  )
  {
    ...
    this.steeringForce.set(desiredSteeringForce);

    console.log(this.steeringForce, this.desiredVelocity);
